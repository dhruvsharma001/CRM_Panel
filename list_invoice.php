...
<div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
		...
		<li class="active">Invoices Upload</li>
      </ol>
    </section>
                ...
                <form method="post" action="action.php" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <button class="btn btn-primary" name="submitInvoice" value="Submit" id="uploadFiles" onclick="upload(uploadFiles)">Submit</button>
                        </div>
                    </div>
                </form>
            </div>
