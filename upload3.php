...
require_once dirname(__FILE__) . '/DbConnect.php';
 ...
 $stmt = $this->conn->prepare("INSERT INTO images (description, image) VALUES (?, ?)");
 ...
 $stmt = $this->conn->prepare("SELECT id, description FROM images ORDER BY id DESC");
 $stmt->execute();
 ...
 $stmt = $this->conn->prepare("SELECT image FROM images WHERE id = ?");
