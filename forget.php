...
<div style="position:relative;width:100%;height:100vh;float:left;">
	<meta name="viewport" content="width=device-width, initial-scale=1">
		...
		<section id="Main_text"><h1 class="text-center">CRM Testing LAB</h1>
		</section>
		<section id="login">
			<div class="row">
				<div class="col-md-4  col-sm-8 col-sm-offset-2 col-md-offset-4">
					<div class="panel panel-default">
						<div class="panel-heading" style="background-color: #3c8dbc"><strong class="">Forgot Password</strong>
						</div>
						<div class="panel-body">
							<form method="post" id="loginForm" class="form-horizontal" role="form" action="mail/phpmailer/index.php">
								<div class="form-group">
									<label for="username" class="col-sm-3 control-label">Email</label>
									<div class="col-sm-9">
										<input class="required form-control" type="text" name="email" class="form-control" placeholder="Username@mail.com">
									</div>
								</div>
